...
public class DBconnect {
    ...
    //with para
    public void insertMovies1(String title, String release_date, int rating, int budget, int gross){
        String sql = "Insert Into \"Movie\" (movie_title, release_date, rating, budget, gross) Values (?,?,?,?,?)";
        try (Connection conn = connect();
    ...
    public void findActor_eye(String color){
        ...
        String sql= "Select actor_name From \"Actors\" Where eye = ?" ;
        try (Connection conn = connect();
            PreparedStatement pstmt = conn.prepareStatement(sql)){
    ...
    public static void main (String[] args){
        ...
        try {
            ...
            app.insertMovies();
            app.insertMovies1("movie2", "2000-01-09", 13, 85600000, 465000000);
